...
class TestJob implements ShouldQueue
{
    ...
    */
    ...
    {
        return $this?->$user->id;   // is base p job ka instance unique krna .. mtlb ab is user id 1 ki yeh class k naam ki 2 jobs at a time nhe chal sakti
    }
     ...
     * @var int
     */
    public $tries = 2;     // itny tries k bad jab fail hogi tu woh mark as failed  e hogi // yani k 3rsi p fail krdo
    ...
    {
        // rate limitter is k us ky intace ap k given time main chal sakty like 1 minute main 2 chal rhi hon but for withoutoverlapping is like 1 at a time and agr dosra at tu kia krna
        Log::info("queue Middleware");
        //     return [new RateLimited];   // the name of middleware we defined as a class like route middleware  ...
        ...
        return [(new WithoutOverlapping($this->user->id))->releaseAfter(10)];// this cna be used k agr is order ki id ki koi aur job ati tu woh nah chaly , at a time ek e resource manipulate ho
    }
